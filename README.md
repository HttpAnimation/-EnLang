...
## How it works
The backend of EnLang is based off [python](https://www.python.org/) and when ever you run the script for your project it will convert that into a python script for a one time then run that script and remove it.
